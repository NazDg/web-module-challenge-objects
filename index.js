...
console.log(createMenuItem(latte));
...
*/
createMenuItem('CreamyCorn', '3', Dinner);
...
reviews.push({name:"Naz"; rating:6; feeback: "Terrible but  like yellow so" })
console.log(reviews);
